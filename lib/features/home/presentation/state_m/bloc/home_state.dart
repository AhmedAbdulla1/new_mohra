...
class HomeState with _$HomeState {
  ...
  const factory HomeState.weatherLoadingState() = WeatherLoadingState;

  const factory HomeState.weatherLoadedState(WeatherEntity weatherEntity) =
      WeatherLoadedState;

  const factory HomeState.weatherLoadingError(
      AppErrors error,
