    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          //       weatherLoaded = true;
          //       provider.weatherData = state.weatherEntity;
          //       state.weatherEntity.data.toString().logD;
          //     }
          //   },
          //   builder: (context, state) {
          //     state.toString().logD;
