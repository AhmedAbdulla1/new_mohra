          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children:  [
                  Text(Translation.current.Event_Filter,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
              ...
              children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                               Text(Translation.current.Location,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                 Text(Translation.current.Ticket_Type,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                const SizedBox(height: 10,),
                                Wrap(
                                  spacing: 10,
                                  children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                 Text(Translation.current.city,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                const SizedBox(height: 10,),
                                Wrap(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                 Text(Translation.current.Event_Category,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                const SizedBox(height: 10,),
                            ...
                            child: Column(
                              ...
                              children: [
                                 Padding(
                                  ...
                                  child:  Text(Translation.current.Event_Date,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                ),
                                const SizedBox(height: 10,),
                                Wrap(
                                  spacing: 10,
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(Translation.current.view_details,style: const TextStyle(fontSize: 16,color: Colors.white),),
                    ),
                  ),
                ),
              ],
