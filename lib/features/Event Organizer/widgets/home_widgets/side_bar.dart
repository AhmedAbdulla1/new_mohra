                ...
                children: [
                  ...
                  const SizedBox(height: 30,),
                   Padding(
                     ...
                     child: Center(child: Text(UserSessionDataModel.fullName ??"",textAlign: TextAlign.center,style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),
                   ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 10,),
                               Text(UserSessionDataModel.name??"",style: const TextStyle(color: Color(0xFFCC471A)),
                        ),
                            ],
                          ),
                      ),
                  ...
                  // const SizedBox(height: 10,),
                   ...
                   Padding(
                     ...
                     child: Text(UserSessionDataModel.emailAddress??"",style: const TextStyle(color: Colors.grey,fontSize: 12),),
                   ),
                  const Spacer(),
                  Padding(
                    padding: EdgeInsets.symmetric(
