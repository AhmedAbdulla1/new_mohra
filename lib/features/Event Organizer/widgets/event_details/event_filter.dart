          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children:  [
                  Text(Translation.current.Filter_attendees,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(Translation.current.CheckIn_Status,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
