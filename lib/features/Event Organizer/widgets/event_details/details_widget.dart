          ...
          InkWell(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children:  [
                                 Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(Translation.current.Attendees_Info,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                ),
                                InkWell(
                                  onTap: (){
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: 10,),
                                               Text(widget.sn.getTicketReportResponseEntity!.allTicketCount.toString(),style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                                              const SizedBox(height: 20,),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: 10,),
                                              if(widget.sn.getTicketReportResponseEntity != null)
                                               Text(widget.sn.getTicketReportResponseEntity!.ticketScannedCount.toString(),style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                                              const SizedBox(height: 20,),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 10,),
                                          if(widget.sn.getTicketReportResponseEntity != null)
                                           Text(widget.sn.getTicketReportResponseEntity!.totalTicketCount.toString(),style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                                          const SizedBox(height: 20,),
            ...
            child: Row(
              children: [
                ...
                if(widget.sn.getTicketReportResponseEntity != null)
                 Text(widget.sn.getTicketReportResponseEntity!.ticketScannedCount.toString()+ "/" +widget.sn.getTicketReportResponseEntity!.allTicketCount.toString()+" "+Translation.current.Checked_In,style: const TextStyle(fontWeight: FontWeight.normal,fontSize: 18),)
              ],
            ),
          ),
