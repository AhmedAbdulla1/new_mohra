...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  updateSettings(UpdateSettingsParams param) async {
    ...
    result.pick(
        onData: (data) => emit(const SettingsState.updateSettingsDone()),
        onError: (error) => emit(
          SettingsState.settingsErrorState(
  ...
  updateCommentsSettings(UpdateCommentsSettingsParams param) async {
    ...
    result.pick(
        onData: (data) => emit(const SettingsState.updateCommentSettingsDone()),
        onError: (error) => emit(
          SettingsState.settingsErrorState(
  ...
  updateMomentsSettings(UpdateMomentsSettingsParams param) async {
    ...
    result.pick(
        onData: (data) => emit(const SettingsState.updateMomentsSettingsDone()),
        onError: (error) => emit(
          SettingsState.settingsErrorState(
