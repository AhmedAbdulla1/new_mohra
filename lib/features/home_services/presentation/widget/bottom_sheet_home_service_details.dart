...
void bottomSheetHomeServiceDetails(
  ...
  showModalBottomSheet(
      ...
      builder: (builder) {
        return const BottomSheetHomeServiceDetails();
      });
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Gaps.vGap32,
          const HomeServiceWidget(isButtonOrder: false,),
          // Gaps.vGap32,
          Expanded(
            child: Scrollbar(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(Translation.current.About_the_services,style: const TextStyle(
                          fontSize: 14,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(16.0),
                      child: Text(Translation.current.Services_benefit,style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppColors.black),),
                    ),
          ...
          Padding(
            ...
            child: CustomMansourButton(
              ...
              title: Text(Translation.current.order,style: const TextStyle(color: AppColors.white),),
            ),
          )
        ],
      ),
