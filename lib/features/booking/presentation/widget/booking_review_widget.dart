    ...
    return Container(
      ...
      child: Column(
        children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text("4.9",style: TextStyle(color: AppColors.white),),
                        ],
                      ),
                    )
          ...
          Gaps.vGap40,
          const Text("“Rachel Massey made all the administration required for renting out my flat completely stress free."),
          Gaps.vGap40,
          SizedBox(
            height: 60,
            child: ListView(
