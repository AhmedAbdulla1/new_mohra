      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                      width: 0.66.sw - 32,
                      child: const Text("Traditional Hot Towel Wet Shave Experience")),
                  const Text("50 min",style: TextStyle(color: AppColors.mansourGrey2),),
                ],
              )
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(Translation.current.SAR+" 23.00",style: const TextStyle(fontWeight: FontWeight.bold),),
