    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          const TextStyle(fontWeight: FontWeight.normal,fontSize: 20,color: Colors.grey),),
        ),
        const SizedBox(height: 20,),
        // Ticket widget
        ...
        const SizedBox(height: 10,),
         Padding(
           padding: const EdgeInsets.symmetric(horizontal: 8),
           child: Text("${sn.eventTicketEntity.number}",style: const TextStyle(fontSize: 18,color: Colors.black,)),
         ),
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 8),
          child: Text("#${sn.eventTicketEntity.bookingId}",style: const TextStyle(fontSize: 18,color: Colors.black,)),
        ),
        ...
        const SizedBox(height: 10,),
         Padding(
           padding: const EdgeInsets.symmetric(horizontal: 8),
           child: Text("${sn.eventTicketEntity.price} SAR",style: const TextStyle(fontSize: 18,color: Colors.black,)),
         ),
    ...
    return sn.eventTicketEntity.scanned? InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
             Text("${sn.eventTicketEntity.scanned ? Translation.current.Checked_In: Translation.current.Check_In}",style: const TextStyle(color: Colors.white),),
            const SizedBox(width: 10,),
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
             Text(Translation.current.Check_In,style: const TextStyle(color: Colors.white),),
            const SizedBox(width: 10,),
            const Icon(Icons.check,color: Colors.white,)
          ],
        ),
