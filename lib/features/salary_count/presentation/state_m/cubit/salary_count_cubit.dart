...
class SalaryCountCubit extends Cubit<SalaryCountState> {
  ...
  void createTimeTable(CreateTimeTableParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const SalaryCountState.createTimeTableLoaded()),
      onError: (error) => emit(
        SalaryCountState.salaryCountErrorState(
  ...
  void changeSelectedTimeTable(ChangeSelectedTimeTableParams params) async {
    ...
    result.pick(
      onData: (data) {
        emit(const SalaryCountState.changeTimeTableSelectedLoaded());
        },
      onError: (error) => emit(
        SalaryCountState.salaryCountErrorState(
  ...
  void deleteTimeTable(DeleteTimeTableParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const SalaryCountState.deleteTimeTableLoaded()),
      onError: (error) => emit(
        SalaryCountState.salaryCountErrorState(
  ...
  void updateTimeTable(UpdateTimeTableParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const SalaryCountState.updateTimeTableLoaded()),
      onError: (error) => emit(
        SalaryCountState.salaryCountErrorState(
  ...
  void customizeTimeTable(CustomizeTimeTableParams params) async {
    ...
    result.pick(
      onData: (data) => emit(const SalaryCountState.changeTimeTableSelectedLoaded()),
      onError: (error) => emit(
        SalaryCountState.salaryCountErrorState(
