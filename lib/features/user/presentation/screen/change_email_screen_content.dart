          ...
          BlocConsumer<UserCubit, UserState>(
              ...
              listener: (context, state) {
                ...
                if(state is UserErrorState){
                  ErrorViewer.showError(context: context, error: state.error, callback: (){},errorViewerOptions: const ErrVSnackBarOptions(
                  ));
                }
              ...
              builder: (context, state) {
                return state.map(
                  addressSelectedDone: (s) => const ScreenNotImplementedError(),
                  setSelectAddress: (s) => const ScreenNotImplementedError(),
                  ...
                  addressDeleted: (s) => const ScreenNotImplementedError(),
                  ...
                  getAddressesDone: (s) => const ScreenNotImplementedError(),
