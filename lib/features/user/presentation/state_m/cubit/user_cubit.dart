...
class UserCubit extends Cubit<UserState> {
  ...
  void changePassword(ChangePasswordParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const UserState.changePasswordDone()),
      onError: (error) => emit(
  ...
  void addAddress(CreateAddressParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const UserState.addAddressDone()),
      onError: (error) => emit(
  ...
  void deleteAddress(DeleteAddressParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const UserState.addressDeleted()),
      onError: (error) => emit(
  ...
  void deleteAccount(DeleteAccountParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const UserState.deleteAccountDone()),
      onError: (error) => emit(
  ...
  void changeEmail(ChangeEmailParams params) async {
    ...
    print('aassd');
    result.pick(
      onData: (data) => emit(const UserState.emailChanged()),
      onError: (error) => emit(
